...
export const magicLog = (ops={}) => {
    const {host="http://blog.moyuyc.xyz"} = ops;
    ...
    console.log(
        " "+"%cWelcome"+"%c "+fish+"\n"+
        " "+"%c欢迎订阅"+downHand+ "\n %c" + host+"/subscribe",
        clr+"font-size:3.1rem;",
        clr+"font-size:2.2rem;",
        "font-size:0.85rem; line-height: .9rem; color: #4a4a4a;",
        "font-size:1.0rem; color: rgb(17,169,138)"//#bada55;
    );
    // console.log("%c"+text," text-shadow: 0 1px 0 #ccc,0 2px 0 #c9c9c9,0 3px 0 #bbb,0 4px 0 #b9b9b9,0 5px 0 #aaa,0 6px 1px rgba(0,0,0,.1),0 0 5px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.3),0 3px 5px rgba(0,0,0,.2),0 5px 10px rgba(0,0,0,.25),0 10px 10px rgba(0,0,0,.2),0 20px 20px rgba(0,0,0,.15);font-size:3.3rem");
}
