...
<!--more-->
# 正文
![ClipboardImage](http://obu9je6ng.bkt.clouddn.com/FsF1gp7vbtW7SW5-JZIRGB81dKyD?imageslim)
如图，操作鼠标搭建如图简单的网络，用到了交换机（端口1-4）-直通线-普通终端。
点击终端图标，进入终端配置界面，点击`Desktop`标签，点击`IP Configuration`，如下图，静态设置IP地址。
![ClipboardImage](http://obu9je6ng.bkt.clouddn.com/FmNY-emWrMeUVUUfJXSe9-VYLT5y?imageslim)
配置完成后，你还可以进入终端的命令行界面`(Command Prompt)`，进行`ping`命令的测试，如下图
![ClipboardImage](http://obu9je6ng.bkt.clouddn.com/FhjrvRjEl-MdAAEfa0GP_xDVjv9w?imageslim)
![ClipboardImage](http://obu9je6ng.bkt.clouddn.com/FtXX7clqbOS62BDMMsQLRtnrZ236?imageslim)
...
```
操作界面如下图所示：
![ClipboardImage](http://obu9je6ng.bkt.clouddn.com/FilWHzc67CSAsMGe7sVhEaVaOtAD?imageslim)
或者你可以利用图形界面进行操作
![ClipboardImage](http://obu9je6ng.bkt.clouddn.com/Fmdpx-owqvC7VGQVMLmD3YnSxFCD?imageslim)
![ClipboardImage](http://obu9je6ng.bkt.clouddn.com/FndZ6bHcsFfIw7MbqVfN7eB1YW26?imageslim)
...
![ClipboardImage](http://obu9je6ng.bkt.clouddn.com/FpZdc9IqufJCH-s6eAK5Dr9GN4Ln?imageslim)
